...
start()
{
    ...
    # Start Test server
    echo -e "${YELLOW}Starting server with: ENVIRONMENT=$ENVIRONMENT PORT=$PORT USERNAME=$USERNAME PASSWORD={***} SERVICE=$AUTH_SERVICE_TEST VERIFY_SSL_CERTS=$VERIFY_SSL_CERTS $python_cmd${RESET}"
