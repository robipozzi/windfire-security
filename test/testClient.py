...
authServerUrl = os.getenv("AUTH_SERVER_URL", "http://localhost:8000")
testServerUrl = os.getenv("TEST_SERVER_URL", "http://localhost:8001")

def authenticate():
    print(Style.BRIGHT + Fore.BLUE + "Call /auth endpoint on Authentication Server ...")
...
def main():
    ...
    print(Style.BRIGHT + Fore.CYAN +"##### Test Health endpoint (NOT AUTHENTICATED) #####")
    print(Style.BRIGHT + Fore.CYAN +"####################################################")
